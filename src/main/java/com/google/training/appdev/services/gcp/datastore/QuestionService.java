...
public class QuestionService {
    ...
    private static final String KIND = "Question";

    private final Datastore datastore = DatastoreOptions.getDefaultInstance().getService();
    private final KeyFactory keyFactory =  datastore.newKeyFactory().setKind(KIND);// new KeyFactory(System.getenv(PROJECT_ENV_VAR));
